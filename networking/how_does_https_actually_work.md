...
To satisfy the client that it is talking to the right server \(and optionally visa versa\) For the parties to have agreed on a “cipher suite”, which includes which encryption algorithm they will use to exchange data
