...
* [Why](docker_cheat_sheet.md#why)
* [Prerequisites](docker_cheat_sheet.md#prerequisites)
* [Installation](docker_cheat_sheet.md#installation)
* [Containers](docker_cheat_sheet.md#containers)
* [Images](docker_cheat_sheet.md#images)
* [Networks](docker_cheat_sheet.md#networks)
* [Registry and Repository](docker_cheat_sheet.md#registry--repository)
* [Dockerfile](docker_cheat_sheet.md#dockerfile)
* [Layers](docker_cheat_sheet.md#layers)
* [Links](docker_cheat_sheet.md#links)
* [Volumes](docker_cheat_sheet.md#volumes)
* [Exposing Ports](docker_cheat_sheet.md#exposing-ports)
* [Best Practices](docker_cheat_sheet.md#best-practices)
* [Security](docker_cheat_sheet.md#security)
* [Tips](docker_cheat_sheet.md#tips)
...
If you want to expose container ports through the host, see the [exposing ports](docker_cheat_sheet.md#exposing-ports) section.
...
A registry is a _host_ -- a server that stores repositories and provides an HTTP API for [managing the uploading and downloading of repositories](https://docs.docker.com/userguide/dockerrepos/).
...
[Registry implementation](https://github.com/docker/docker-registry) has an official image for basic setup that can be launched with [`docker run -p 5000:5000 registry`](https://github.com/docker/docker-registry#quick-start) Note that this installation does not have any authorization controls. You may use option `-P -p 127.0.0.1:5000:5000` to limit connections to localhost only. In order to push to this repository tag image with `repositoryHostName:5000/imageName` then push this tag.

## Dockerfile

[The configuration file](https://docs.docker.com/reference/builder/). Sets up a Docker container when you run `docker build` on it. Vastly preferable to `docker commit`. If you use [jEdit](http://jedit.org), I've put up a syntax highlighting module for [Dockerfile](https://github.com/wsargent/jedit-docker-mode) you can use. You may also like to try the [tools section](docker_cheat_sheet.md#tools).
...
If you're running Docker in Virtualbox, you then need to forward the port there as well, using [forwarded\_port](https://docs.vagrantup.com/v2/networking/forwarded_ports.html). It can be useful to define something in Vagrantfile to expose a range of ports so that you can dynamically map them:
